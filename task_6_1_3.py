...
"""
Реализация класса-структуры "стопка тарелок" из 5 задания 1 домашней работы. 
"""
...
if __name__ == '__main__':
    ...
    print(f'Размер изначального объекта, каким он был в моем дз№1: {asizeof.asizeof(PS_OBJ)}')                # 584
    print(f'Размер того же объекта, но оптимизированного при помощи slots: {asizeof.asizeof(PS_OBJ_SLOTS)}')  # 240
